...
import com.freakapps.android.activityscenetransitionbasic.R;
...
public class DetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHeaderDescription = (TextView) findViewById(R.id.textview_description);
    ...
    private void loadItem() {
        ...
        mHeaderDescription.setText(mItem.getmDescription());

        int resourceId = getResources().getIdentifier(mItem.getThumbnailImageName(), "drawable", getPackageName());
